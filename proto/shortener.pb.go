...
const file_proto_shortener_proto_rawDesc = "" +
	"\n" +
	"\x15proto/shortener.proto\x12\x1eevlushin.shorturl.shortener.v1\x1a\x1bgoogle/protobuf/empty.proto\"%\n" +
	...
	"\x10UserURLsResponse\x129\n" +
	"\x03url\x18\x01 \x03(\v2'.evlushin.shorturl.shortener.v1.URLDataR\x03url\"I\n" +
	"\aURLData\x12\x1b\n" +
	"\tshort_url\x18\x01 \x01(\tR\bshortUrl\x12!\n" +
	"\foriginal_url\x18\x02 \x01(\tR\voriginalUrl2\xd3\x02\n" +
	"\x10ShortenerService\x12s\n" +
	"\n" +
	"ShortenURL\x121.evlushin.shorturl.shortener.v1.URLShortenRequest\x1a2.evlushin.shorturl.shortener.v1.URLShortenResponse\x12p\n" +
	"\tExpandURL\x120.evlushin.shorturl.shortener.v1.URLExpandRequest\x1a1.evlushin.shorturl.shortener.v1.URLExpandResponse\x12X\n" +
	"\fListUserURLs\x12\x16.google.protobuf.Empty\x1a0.evlushin.shorturl.shortener.v1.UserURLsResponseB6Z4https://github.com/Evlushin/shorturl/proto/shortenerb\beditionsp\xe8\a"

var file_proto_shortener_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_shortener_proto_goTypes = []any{
	(*URLShortenRequest)(nil),  // 0: evlushin.shorturl.shortener.v1.URLShortenRequest
	(*URLShortenResponse)(nil), // 1: evlushin.shorturl.shortener.v1.URLShortenResponse
	(*URLExpandRequest)(nil),   // 2: evlushin.shorturl.shortener.v1.URLExpandRequest
	(*URLExpandResponse)(nil),  // 3: evlushin.shorturl.shortener.v1.URLExpandResponse
	(*UserURLsResponse)(nil),   // 4: evlushin.shorturl.shortener.v1.UserURLsResponse
	(*URLData)(nil),            // 5: evlushin.shorturl.shortener.v1.URLData
	(*emptypb.Empty)(nil),      // 6: google.protobuf.Empty
}
var file_proto_shortener_proto_depIdxs = []int32{
	5, // 0: evlushin.shorturl.shortener.v1.UserURLsResponse.url:type_name -> evlushin.shorturl.shortener.v1.URLData
	0, // 1: evlushin.shorturl.shortener.v1.ShortenerService.ShortenURL:input_type -> evlushin.shorturl.shortener.v1.URLShortenRequest
	2, // 2: evlushin.shorturl.shortener.v1.ShortenerService.ExpandURL:input_type -> evlushin.shorturl.shortener.v1.URLExpandRequest
	6, // 3: evlushin.shorturl.shortener.v1.ShortenerService.ListUserURLs:input_type -> google.protobuf.Empty
	1, // 4: evlushin.shorturl.shortener.v1.ShortenerService.ShortenURL:output_type -> evlushin.shorturl.shortener.v1.URLShortenResponse
	3, // 5: evlushin.shorturl.shortener.v1.ShortenerService.ExpandURL:output_type -> evlushin.shorturl.shortener.v1.URLExpandResponse
	4, // 6: evlushin.shorturl.shortener.v1.ShortenerService.ListUserURLs:output_type -> evlushin.shorturl.shortener.v1.UserURLsResponse
